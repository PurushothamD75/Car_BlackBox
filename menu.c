 ...
 *
 * Created on 3 January, 2025, 2:26 PM
 */
...
void read() {
    ...
    for (int i = 0; i < count1; i++) {
        ...
        data1[i][0] = i + '0';
        data1[i][1] = ' ';
        data1[i][2] = read_external_eeprom(0x00 + pos * 10);
        data1[i][3] = read_external_eeprom(0x01 + pos * 10);
        data1[i][4] = ':';
        data1[i][5] = read_external_eeprom(0x02 + pos * 10);
        data1[i][6] = read_external_eeprom(0x03 + pos * 10);
        data1[i][7] = ':';
        data1[i][8] = read_external_eeprom(0x04 + pos * 10);
        data1[i][9] = read_external_eeprom(0x05 + pos * 10);
        data1[i][10] = ' ';
        data1[i][11] = read_external_eeprom(0x06 + pos * 10);
        data1[i][12] = read_external_eeprom(0x07 + pos * 10);
        data1[i][13] = ' ';
        data1[i][14] = read_external_eeprom(0x08 + pos * 10);
        data1[i][15] = read_external_eeprom(0x09 + pos * 10);
        data1[i][16] = '\0';
        pos++;
    }
}
